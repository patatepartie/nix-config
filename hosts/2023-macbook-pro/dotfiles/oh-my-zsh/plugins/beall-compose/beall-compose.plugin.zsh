...
alias bclu='beall-compose up --build believe believe_celery_matching believe_celery_brag'
alias bcluh='beall-compose -a honeycomb up --build believe believe_celery_matching believe_celery_brag'
...
alias bcpu='beall-compose -s beproduced up --build beproduced_web beproduced_celery'
alias bcpuh='beall-compose -s beproduced -a honeycomb up --build beproduced_web beproduced_celery'
