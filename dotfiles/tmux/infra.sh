...
tmux new-window -t $SESSION:3 -c "${TOP_DIR}/deploy" -n 'vault'
tmux new-window -t $SESSION:4 -c "${TOP_DIR}" -n 'prod'
tmux new-window -t $SESSION:5 -c "${TOP_DIR}" -n 'uat'
tmux new-window -t $SESSION:6 -c "${TOP_DIR}/new-relic" -n 'new-relic'
